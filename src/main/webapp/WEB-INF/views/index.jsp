...
<html>
    ...
    <spring:url value="/resources/js/jsonp.js" var="jsonp"/>
    <%--images paths--%>
    ...
    <script type="text/javascript" src="${jsonp}"></script>
</head>
<body>
<!--HEADER-->
        ...
        <div class="search_form">
            ...
            <div class="params" id="params">
                <div class="params_tuggle">
                    ...
                    <fieldset>
                        <legend style="color: #111111;">Период предъявления</legend>
                        <table>
                            <tr>
                                <td><p>от</p></td>
                ...
                <li><a href="" class="mark" title="Журналы"><img src="${journalpng}"/></a>
                    <ul class="sub-nav">
                        ...
                        <sec:authorize ifAnyGranted="ROLE_ALL,ROLE_CONTROL,ROLE_SETKA">
                            <li><a href="${v_setka}" title="Сетка, лента, проволка">Сетка, лента, проволока</a></li>
                        </sec:authorize>
        ...
        <div id="list_magazin" class="list_magazin">
            <sec:authorize ifAnyGranted="ROLE_ALL,ROLE_CONTROL,ROLE_METAL">
                <a href="${v_metal}" title="Металл (черный и цветной)">
                    <article>
                        <p>Металл (черный и цветной)</p>
                        <p class="notification" id="metall"/>
                    </article>
                </a>
            </sec:authorize>
            <sec:authorize ifAnyGranted="ROLE_ALL,ROLE_CONTROL,ROLE_COMPL">
                <a href="${v_complect}" title="Комплектующие">
                    <article>
                        <p>Комплектующие</p>
                        <p class="notification" id="complect"/>
                    </article>
                </a>
            </sec:authorize>
            <sec:authorize ifAnyGranted="ROLE_ALL,ROLE_CONTROL,ROLE_CHEMISTRY">
                <a href="${v_chemistry}" title="Химия, ГСМ">
                    <article>
                        <p>Химия, ГСМ</p>
                        <p class="notification" id="himiya"/>
                    </article>
                </a>
            </sec:authorize>
            <sec:authorize ifAnyGranted="ROLE_ALL,ROLE_CONTROL,ROLE_NONMETAL">
                <a href="${v_nometal}" title="Неметаллические материалы">
                    <article>
                        <p>Неметаллические материалы</p>
                        <p class="notification" id="no-metall"/>
                    </article>
                </a>
            </sec:authorize>
            <sec:authorize ifAnyGranted="ROLE_ALL,ROLE_CONTROL,ROLE_SETKA">
                <a href="${v_setka}" title="Сетка, лента, проволка">
                    <article>
                        <p>Сетка, лента, проволока</p>
                        <p class="notification" id="setka"/>
                    </article>
                </a>
            </sec:authorize>
            <sec:authorize ifAnyGranted="ROLE_ALL,ROLE_CONTROL,ROLE_METIZ">
                <a href="${v_metiz}" title="Метизы">
                    <article>
                        <p>Метизы</p>
                        <p class="notification" id="metiz"/>
                    </article>
                </a>
            </sec:authorize>
        </div>
        <!--LIST MAGAZIN END-->
        <h2 id="title_page">Вся продукция</h2>
        <div id="zizi"/>
        <!--TABLE PRODUCT-->
            ...
            <form id="create_product" enctype="multipart/form-data">
                <table id="t_modal" class="t_modal">
                    ...
                    <tr>
                        ...
                        <td class="t_td_input">
                            <sec:authorize ifAnyGranted="ROLE_CHEMISTRY,ROLE_COMPL,ROLE_METAL,ROLE_METIZ,ROLE_NONMETAL,ROLE_SETKA">
                                <input class="datepicker" type="button" value="Календарь"/>
                            </sec:authorize>
                            <sec:authorize ifAnyGranted="ROLE_CONTROL,ROLE_USER,ROLE_ADMIN,ROLE_ALL">
                                <input class="datepicker" type="button" value="Календарь" disabled/>
                            </sec:authorize>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="t_td_input_term">
                            <sec:authorize ifAnyGranted="ROLE_CHEMISTRY,ROLE_COMPL,ROLE_METAL,ROLE_METIZ,ROLE_NONMETAL,ROLE_SETKA">
                                <input class="datepicker_term" type="button" value="Календарь"/>
                                <label><input type="checkbox" class="no_term"> Без гарантийного срока</label>
                            </sec:authorize>
                            <sec:authorize ifAnyGranted="ROLE_CONTROL,ROLE_USER,ROLE_ADMIN,ROLE_ALL">
                                <input class="datepicker_term" type="button" value="Календарь" disabled/>
